...
{$sql3="update LMS.book set Availability=Availability-1 where BookId='$bookid'";
 ...
 $sql5="insert into LMS.message (RollNo,Msg,Date,Time) values ('$rollno','Your request to work on Project: $bookid  has been accepted',curdate(),curtime())";
...
{$sql2="update LMS.record set Date_of_Issue=curdate(),Due_Date=date_add(curdate(),interval 60 day),Renewals_left=1 where BookId='$bookid' and RollNo='$rollno'";

if($conn->query($sql2) === TRUE)
{$sql4="update LMS.book set Availability=Availability-1 where BookId='$bookid'";
 $result=$conn->query($sql4);
 $sql6="insert into LMS.message (RollNo,Msg,Date,Time) values ('$rollno','Your request to work on Project: $bookid has been accepted',curdate(),curtime())";
