                                ...
                                ?>
                                    ...
                                    <form class="form-horizontal row-fluid" action="edit_book_details.php?id=<?php echo $bookid ?>" method="post">
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Title">Project Title:</label></b>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Publisher">Developer:</label></b>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <b>
                                            <label class="control-label" for="Availability">No. of members:</label></b>
                                            <div class="controls">
