                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="edit_student_details.php?id=<?php echo $rollno ?>" method="post">
                                    ...
                                    <div class="control-group">
                                            <label class="control-label" for="Category"><b>Qualification:</b></label>
                                            <div class="controls">
                                                <select name = "Category" tabindex="1" value="SC" data-placeholder="Select Category" class="span6">
                                                    ...
                                                    <option value="OBC">MTech</option>
                                                    <option value="SC">Phd</option>
                                                    <option value="ST">MBA</option>
                                                </select>
                                            </div>
                                    </div>
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy;2023 Univeristy Project Bank</b>All rights reserved.
            </div>
        </div>
